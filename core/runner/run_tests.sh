...
#    Updated: 2021/11/09 09:01:17 by mmelo-da         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
compile_test_file()
{
	...
	MAIN_FILE="$1"
	COMPIL_ARGS="${COMPIL_FLAGS} $1 -lbsd -L${PATH_LIBFT} -lft -I${PATH_LIBFT} -I${PATH_TEST}/core/framework ${PATH_TEST}/core/framework/*.c "

	printf "$> gcc -lbsd ${COMPIL_ARGS} -o ${PATH_TEST}/test_file \n\n" >> ${PATH_DEEPTHOUGHT}/deepthought
